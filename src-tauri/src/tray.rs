...
pub fn create() -> SystemTray {
    let open = CustomMenuItem::new("open_chatgpt", "Focus ChatGPT");
    let prompt = CustomMenuItem::new("toggle_window", "Toggle ChatGPT Window");
...
pub fn handler(app: &AppHandle, event: SystemTrayEvent) {
    if let SystemTrayEvent::MenuItemClick { id, .. } = event {
        ...
        match id.as_str() {
            ...
            "toggle_window" => quick_prompt::toggle(app),
